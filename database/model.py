...
class User(BaseModel):
    ...
    username = CharField(max_length=32, null=True,  unique=False, verbose_name='Username')
...
class Account(BaseModel):
    ...
    created_date = DateField(default=datetime.now().date(), verbose_name='Дата создания')
...
class Category(BaseModel):
    ...
    category_name = CharField(max_length=32, null=False, unique=False, verbose_name='Категория')
...
class Transaction(BaseModel):
    ...
    transaction_date = DateField(default=datetime.now().date(), verbose_name='Дата транзакции')
